...
import { CreateShop } from "@/app/requests";
		...
		<div className="col-md-8 col-lg-8 pb-4">
		  ...
		  <form>
			<div className="row">
			  ...
			  <div className="col-6">
				<div className="form-group">
				  <label className="text-black" for="lname">Address</label>
			...
			onClick={async()=>{
				const res =await CreateShop(inputValueName,inputValueDesc,inputValueBanner,inputValueAddress,inputValuePhone,inputValueEmail,-0.23344,5.456787);
				if(res._id){
					alert('Shop has been created successfully!');
				}
			}}>Create Shop</div>
		  </form>
